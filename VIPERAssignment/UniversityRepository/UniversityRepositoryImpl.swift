...
class UniversityRepositoryImpl: UniversityRepository {
    ...
    private let remoteDataSource: UniversityRepository
    private let localDataSource: LocalUniversityDataSource

    init(remoteDataSource: UniversityRepository, localDataSource: LocalUniversityDataSource) {
